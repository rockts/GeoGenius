...
html = replace_region(html, 'g3-helpers',  extract_section(g3,  'helpers'))
html = replace_region(html, 'g3-anims',    extract_section(g3,  'anims'))
